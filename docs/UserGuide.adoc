= Address Book and Booklets (AB&B) - User Guide
:toc:
:toc-title:
...
Format: `add n/NAME p/PHONE_NUMBER [e/EMAIL] [a/ADDRESS] [r/AVATAR_FILEPATH] [nokn/NOK_NAME] [nokp/NOK_PHONE] [t/TAG]...`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [r/AVATAR_FILEPATH] [nokn/NOK_NAME] [nokp/NOK_PHONE] [t/TAG]...`
...
* *Add* `add n/NAME p/PHONE_NUMBER [e/EMAIL] [a/ADDRESS] [r/AVATAR_FILEPATH] [nokn/NOK_NAME] [nokp/NOK_PHONE] [t/TAG]...` +
...
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [r/AVATAR_FILEPATH] [nokn/NOK_NAME] [nokp/NOK_PHONE] [t/TAG]...` +
